...
<p>Berikut ini adalah data Anda yang terdaftar di database Politeknik Negeri Lampung:
</p>
<br>
	...
	<div class="box box-info">
		...
		<div class="box-body">
			...
			<div class="col-sm-12" style="margin-top:20px;">
				<p><b>Note : </b><font color="red">Jika ada kesalahan pada data Anda, harap hubungi BAAK Polinela untuk memperbaiki.</font></p>
			</div>
		</div>
	</div>
</div>
